    ...
    <div>
        ...
        <div class="product-detail-container">
            ...
            <div class="product-detail-container01">
                ...
                <div class="product-detail-container02">
                    <div data-thq="slider" data-navigation="true" data-pagination="true" class="product-detail-slider swiper">
                        <div data-thq="slider-wrapper" class="swiper-wrapper">
                            <div data-thq="slider-slide" class="product-detail-slider-slide swiper-slide"><img src="public/15-700h.jpg" alt="image" class="product-detail-image" /></div>
                            <div data-thq="slider-slide" class="product-detail-slider-slide1 swiper-slide"><img src="public/15-700h.jpg" alt="image" class="product-detail-image1" /></div>
                            <div data-thq="slider-slide" class="product-detail-slider-slide2 swiper-slide"><img src="public/15-700h.jpg" alt="image" class="product-detail-image2" /></div>
                        </div>
                ...
                <div class="product-detail-container03"><span class="product-detail-text">Apple iPhone 15 Pro (128 GB) - Blue Titanium | [Locked] | Boost
                        Infinite plan required starting at $60/mo. | Unlimited Wireless |
                        No trade-in needed to start | Get the latest iPhone every
                        year</span>
                    <div class="product-detail-container04"><span class="product-detail-text01">Ratings: </span>
                        <div class="product-detail-container05"><svg viewBox="0 0 950.8571428571428 1024" class="product-detail-icon">
                                ...
                                <path d="M950.857 369.714c0 10.286-7.429 20-14.857 27.429l-207.429 202.286 49.143 285.714c0.571 4 0.571 7.429 0.571 11.429 0 14.857-6.857 28.571-23.429 28.571-8 0-16-2.857-22.857-6.857l-256.571-134.857-256.571 134.857c-7.429 4-14.857 6.857-22.857 6.857-16.571 0-24-13.714-24-28.571 0-4 0.571-7.429 1.143-11.429l49.143-285.714-208-202.286c-6.857-7.429-14.286-17.143-14.286-27.429 0-17.143 17.714-24 32-26.286l286.857-41.714 128.571-260c5.143-10.857 14.857-23.429 28-23.429s22.857 12.571 28 23.429l128.571 260 286.857 41.714c13.714 2.286 32 9.143 32 26.286z"></path>
                            </svg><span class="product-detail-text02">5.0</span></div>
                    </div>
                    <form class="product-detail-form">
                        <div class="product-detail-container06"><span class="product-detail-text03">Selected Type:&nbsp;</span><select class="product-detail-select">
                        ...
                        <div class="product-detail-container08"><button type="button" class="product-detail-button button"><span><span>BUY NOW!</span><br /></span></button><button type="button" class="product-detail-button1 button"><span><span>ADD TO CHART</span><br /></span></button></div>
                    </form>
                </div>
            </div>
            <div class="product-detail-container09"><span class="product-detail-text12">Related Products</span>
                <div class="product-detail-container10"><a href="product-detail.html" class="product-detail-navlink">
                        <div class="product-detail-container11"><img alt="image" src="public/external/15%20promax-200w-200w.jpg" class="product-detail-image3" /><span>iPhone 15 Pro Max </span></div>
                    </a><a href="product-detail.html" class="product-detail-navlink1">
                        <div class="product-detail-container12"><img alt="image" src="public/external/15%20promax-200w-200w.jpg" class="product-detail-image4" /><span><span>iPhone 15 Pro</span><br /></span></div>
                    </a><a href="product-detail.html" class="product-detail-navlink2">
                        <div class="product-detail-container13"><img alt="image" src="public/15plus-200w.jpg" class="product-detail-image5" /><span>iPhone 15 Plus</span></div>
                    </a><a href="product-detail.html" class="product-detail-navlink3">
                        <div class="product-detail-container14"><img alt="image" src="public/15-700h.jpg" class="product-detail-image6" /><span>iPhone 15</span></div>
                    </a></div><img alt="image" src="public/Pineapple Icons/pro1._cb585551876_-1500w.jpg" class="product-detail-image7" />
            </div>
        </div>
    </div>
