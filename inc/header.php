      ...
      <header data-role="Header" class="homepage-header max-width-container">
        <div class="homepage-navbar">
          ...
          <a href="index.php" class="homepage-navlink">
            <div class="logo-container navbar-logo-title logo-root-class-name16">
              <span class="logo-logo-center Logo navbar-logo-title">
                <span>PineApple</span>
              </span>
              <img alt="image" src="public/Pineapple Icons/logo_no_bg_2-200h.png" class="logo-image" />
            </div>
          </a>
          ...
          <form class="homepage-form" action="search-page.php" method="get">
            <div class="homepage-container01">
              <input type="text" id="Search bar" name="search" placeholder="Search for products" autocomplete="off" class="homepage-textinput input" />
          ...
          <div class="homepage-icons">
            ...
            <!-- Shopping cart icon -->
            <a href="<?php echo $cart_icon_link; ?>" class="homepage-navlink1 button">
            ...
            <div data-thq="thq-dropdown" class="homepage-thq-dropdown list-item">
              <div data-thq="thq-dropdown-toggle" class="homepage-dropdown-toggle">
                <div data-thq="thq-dropdown-arrow" class="homepage-dropdown-arrow">
              ...
              <ul data-thq="thq-dropdown-list" class="homepage-dropdown-list">
                ...
                <!-- if login -->
                <?php if ($login) : ?>
                  <li data-thq="thq-dropdown" class="homepage-dropdown list-item">
                    <a href="personal-info.html">
                      <div data-thq="thq-dropdown-toggle" class="homepage-dropdown-toggle1">
                        <span class="homepage-text01">Information</span>
                      </div>
                    </a>
                  </li>
                  <li data-thq="thq-dropdown" class="homepage-dropdown1 list-item">
                    <a href="?cid=<?php Session::get('cmrId') ?>">
                      <div data-thq="thq-dropdown-toggle" class="homepage-dropdown-toggle2">
