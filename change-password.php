...
<head>
  ...
  <meta property="og:title" content="Change-Password - PineApple" />
    ...
    <div class="change-password-container">
      <header data-role="Header" class="admin-page-header2-header max-width-container">
        <div class="admin-page-header2-navbar"><a href="index.php" class="admin-page-header2-navlink">
          ...
          </a><a href="change-password.php" class="admin-page-header2-navlink1 navbar-link"><span>PineApple - ChangePassword</span><br /></a>
      ...
      <div class="change-password-container1">
        ...
        ?>
            ...
            <span class="change-password-text">Change Password</span><span class="change-password-text1">&gt; </span><span class="change-password-text2">&gt; </span><a href="login-and-security.php" class="change-password-navlink"><span>&nbsp; &nbsp; </span><span class="change-password-text4">Login &amp; Security</span></a><a href="personal-info.php" class="change-password-navlink1">Your Account
            </a>
      </div>
      <h1 class="change-password-text5">Change Password</h1>
      <div class="change-password-container2"><span class="change-password-text6">To change the password for your PineApple account, use this
          form.</span><span class="change-password-text7">New Password</span>
        <form action="" method="post">
          <input name="pass" type="text" class="change-password-textinput input"/>
          <input type="submit" name="submit" value="Confirm" class="change-password-navlink2 button">
        </form>
