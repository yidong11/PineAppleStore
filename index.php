    ...
    <div class="max-width-container">
      ...
      <div class="homepage-gallery">
        ...
        <div class="homepage-left">
          <div class="item-card11-gallery-card">
            <img alt="image" src="admin/<?php echo $result['image']; ?>" class="item-card11-image" />
            <div class="item-card11-container">
              <h3 class="item-card11-text">
                <span><?php echo $result['productName']; ?></span>
              </h3>
              <div class="item-card11-container1">
                <svg viewBox="0 0 1024 1024" class="item-card11-icon">
                  <path d="M512 736l-264 160 70-300-232-202 306-26 120-282 120 282 306 26-232 202 70 300z"></path>
                </svg><svg viewBox="0 0 1024 1024" class="item-card11-icon02">
                  <path d="M512 736l-264 160 70-300-232-202 306-26 120-282 120 282 306 26-232 202 70 300z"></path>
                </svg><svg viewBox="0 0 1024 1024" class="item-card11-icon04">
                  <path d="M512 736l-264 160 70-300-232-202 306-26 120-282 120 282 306 26-232 202 70 300z"></path>
                </svg><svg viewBox="0 0 1024 1024" class="item-card11-icon06">
                  <path d="M512 736l-264 160 70-300-232-202 306-26 120-282 120 282 306 26-232 202 70 300z"></path>
                </svg><svg viewBox="0 0 1024 1024" class="item-card11-icon08">
                  <path d="M512 736l-264 160 70-300-232-202 306-26 120-282 120 282 306 26-232 202 70 300z"></path>
                </svg>
              </div>
              <div class="item-card11-container2">
                <span class="item-card11-currency"><span>HKD</span></span>
                <span class="item-card11-value"><span><?php echo $result['price']; ?></span></span>
              </div>
            </div>
          </div>
        </div>
