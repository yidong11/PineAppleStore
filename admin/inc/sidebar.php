<div class="admin-page-navbar-container column">
    <div
        ...
        class="admin-page-navbar-thq-dropdown list-item"
    >
        <div
        data-thq="thq-dropdown-toggle"
        class="admin-page-navbar-dropdown-toggle"
        >
        <svg viewBox="0 0 1024 1024" class="admin-page-navbar-icon">
            <path
        ...
        <span class="admin-page-navbar-text">User Information</span>
        <div
            data-thq="thq-dropdown-arrow"
            class="admin-page-navbar-dropdown-arrow"
        >
            <svg
            viewBox="0 0 877.7142857142857 1024"
            class="admin-page-navbar-icon02"
            >
            <path
        ...
        class="admin-page-navbar-dropdown-list"
        >
        <a href="user-list.php">
            <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown list-item"
            >
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle01"
            >
                <span class="admin-page-navbar-text01">User List</span>
            </div>
            </li>
        </a>
        </ul>
    ...
    >
        ...
        <span class="admin-page-navbar-text03">Brand Information</span>
        <div
            data-thq="thq-dropdown-arrow"
        ...
        <a href="brand-list.php">
            ...
            >
                <span class="admin-page-navbar-text04">Brand List</span>
            </div>
            </li>
        </a>
        <a href="brand-add.php">
            <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown3 list-item"
            >
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle05"
            >
                <span class="admin-page-navbar-text05">Add Brand</span>
            </div>
            </li>
        </a>
        </ul>
    ...
    >
        <div
        data-thq="thq-dropdown-toggle"
        class="admin-page-navbar-dropdown-toggle06"
        >
        <svg viewBox="0 0 1024 1024" class="admin-page-navbar-icon08">
            <path
        ...
        <span class="admin-page-navbar-text06">
            Category Information
        </span>
        <div
            data-thq="thq-dropdown-arrow"
            class="admin-page-navbar-dropdown-arrow2"
        >
            <svg
            viewBox="0 0 877.7142857142857 1024"
            class="admin-page-navbar-icon10"
            >
            <path
                d="M877.714 768v73.143c0 20-16.571 36.571-36.571 36.571h-804.571c-20 0-36.571-16.571-36.571-36.571v-73.143c0-20 16.571-36.571 36.571-36.571h804.571c20 0 36.571 16.571 36.571 36.571zM877.714 475.429v73.143c0 20-16.571 36.571-36.571 36.571h-804.571c-20 0-36.571-16.571-36.571-36.571v-73.143c0-20 16.571-36.571 36.571-36.571h804.571c20 0 36.571 16.571 36.571 36.571zM877.714 182.857v73.143c0 20-16.571 36.571-36.571 36.571h-804.571c-20 0-36.571-16.571-36.571-36.571v-73.143c0-20 16.571-36.571 36.571-36.571h804.571c20 0 36.571 16.571 36.571 36.571z"
            ></path>
        ...
        <ul
        data-thq="thq-dropdown-list"
        class="admin-page-navbar-dropdown-list2"
        >
        <a href="category-list.php">
            <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown4 list-item"
            >
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle07"
            >
                <span class="admin-page-navbar-text07">
                Category List
                </span>
            </div>
            </li>
        ...
        <a href="category-add.php">
            <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown5 list-item"
            >
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle08"
            >
                <span class="admin-page-navbar-text08">Add Category</span>
            </div>
            </li>
        </a>
        </ul>
    ...
    >
        ...
        <ul
        data-thq="thq-dropdown-list"
        class="admin-page-navbar-dropdown-list3"
        >
        <a href="product-list.php">
            <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown6 list-item"
            >
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle10"
            >
                <span class="admin-page-navbar-text10">Product List</span>
            </div>
            </li>
        </a>
        <li
            data-thq="thq-dropdown"
            class="admin-page-navbar-dropdown7 list-item"
        >
            <a href="product-add.php">
            <div
                data-thq="thq-dropdown-toggle"
                class="admin-page-navbar-dropdown-toggle11"
            >
                <span class="admin-page-navbar-text11">Add Product</span>
            </div>
            </a>
        </li>
        </ul>
